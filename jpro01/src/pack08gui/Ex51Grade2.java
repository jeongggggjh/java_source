...
public class Ex51Grade2 extends JFrame implements ActionListener {
	...
	public Ex51Grade2() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int result = JOptionPane.showConfirmDialog(Ex51Grade2.this, "정말 종료?", "종료 확인",
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnCalc) {
			...
			switch (selImage) {
			case 1:
				lblphto.setIcon(new ImageIcon("C:\\work\\jsou\\jpro01\\src\\pack08gui\\따봉흥민.jpeg"));
				break;

			case 2:
				lblphto.setIcon(new ImageIcon("C:\\work\\jsou\\jpro01\\src\\pack08gui\\지친흥민.jpeg"));
				break;
			}
