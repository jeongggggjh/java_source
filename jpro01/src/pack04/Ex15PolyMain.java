...
public class Ex15PolyMain {
	...
	public static void main(String[] args) {
		...
		Ex15PolyCar bus1 = new Ex15PolyBus();
		...
		car2.displaySpeed(); // 오버라이딩 되서 호출 가능.
		System.out.println(car2.getSpeed());
		// car2.show(); // 자식 고유의 메소드는 간섭 불가함, 오버라이딩 된 메소드만 호출 가능
		...
		// Ex15PolyTaxi taxi3 = (Ex15PolyTaxi)car1; // 실행오류(Runtime error)
