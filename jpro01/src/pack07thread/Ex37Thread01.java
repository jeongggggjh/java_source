...
public class Ex37Thread01 extends Thread{
	public Ex37Thread01() {
		
	}
	
	public Ex37Thread01(String name) {
		super(name);
	}
	...
	public static void main(String[] args) {
		...
		// 기본적으로 main thread에 의해 응용프로그램은 실행된다.
		...
		try {
			...
			/*
			Ex37Thread01 th1 = new Ex37Thread01();
			th1.run();
			Ex37Thread01 th2 = new Ex37Thread01();
			th2.run();
			*/
			// 사용자 정의 Thread를 사용한 경우 : 랜덤하게 실행
			// Ex37Thread01 th1 = new Ex37Thread01();
			Ex37Thread01 th1 = new Ex37Thread01("one ");
			th1.start();
			// Ex37Thread01 th2 = new Ex37Thread01();
			Ex37Thread01 th2 = new Ex37Thread01("two ");
			th2.start();
