...
// 예외처리 : 키보드, 파일 처리, 네트워크, DB 연동 처리 등 외부와의 접속을 통한 프로그래밍 작업 중
// 		   예상치 못한 에러가 발생 할 수 있는데, 이와 같은 경우에 주로 사용.
// try ~ catch 구문을 사용
// 
...
public class Ex26Try {
	...
	public void testMethod() {
		...
		try {
			int a[] = { 1, 2, 3 };
			System.out.println("베열 요소 값 출력 : " + a[0]);
			System.out.println("베열 요소 값 출력 : " + a[3]);
		} catch (Exception e) {
