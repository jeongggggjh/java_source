...
public class Test03 {
	...
	public static void main(String[] args) {
		...
		ij = ii >> 1; // << 우측으로 1비트 이동. 남는 좌축은 부호(0 : 양수, 1 : 음수 같은 값으로 채움
		System.out.println("ii : " + ii + ", ij : " +ij); 
		
		ij = ii >>> 2; // << 우측으로 2비트 이동. 남는 좌축은 0으로 채움
		System.out.println("ii : " + ii + ", ij : " +ij); 
		...
		System.out.println("논리 연산자에서 주의할점------");
		/*
		aa();
		...
		*/
		...
		System.out.println("----------");
		// b2 = aa() || bb(); // aa() 수행결과가 참이므로 bb() 수행 안 함.
		// b2 = bb() || aa();
