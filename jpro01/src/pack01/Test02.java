...
public class Test02 {
	...
	public static void main(String[] args) {
		// 응용프로그램의 시작 메소드(method(행위))
		int a = 5; // 치환연산자. 오른쪽의 최종 결과값을 왼쪽 기억장소에 저장 
		int b = 3; 
		int c = a + b;
		...
		//System.out.println(a / 0); // 정수연산인 경우 에러 java.lang.ArithmeticException: / by zero
		System.out.println(a / 0.0); // 실수연산인 경우 Infinity
		System.out.println(a % 0.0); // NaN(Not a Number) 숫자가 아니라 표현 할 수 없는 상태
