...
Server Character Encoding = <%= response.getCharacterEncoding() %><br>
<br>
Context path : <%= application.getContextPath() %><br> <!-- 현재 실행중인 페이지의 외부 환경정보 -->
Session : <%= pageContext.getSession() %>
<br>
session, page, config, exception 등등 내장객체에 해당됨
</body>
</html>